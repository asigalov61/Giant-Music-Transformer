...
Original file is located at
    https://colab.research.google.com/drive/17juzeiXyTvWdLhFmyyCxC27kuJdHqxAP
...
NUM_EPOCHS = 3 # This number depends on your dataset and desired final loss/acc

BATCH_SIZE = 4 # Original and therefore optimal is 4
GRADIENT_ACCUMULATE_EVERY = 4 # Original and therefore optimal is 4

LEARNING_RATE = 2e-5 # A tenth of the original 2e-4
NUM_LAST_LAYERS_TO_UNFREEZE = 2 # I think it should be 2 here

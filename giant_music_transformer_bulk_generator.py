...
Original file is located at
    https://colab.research.google.com/drive/1kaQ2mE26Dj7hTWcoMYtrd9OvQssCiU-m

# Giant Music Transformer Bulk Generator (ver. 1.0)
...
total_number_of_tokens_tp_generate = 2046 # @param {type:"slider", min:30, max:8190, step:3}
...
number_of_tokens_tp_generate = total_number_of_tokens_tp_generate
...
print('=' * 70)
print('Generating', number_of_generation_cycles * number_of_batches_to_generate, 'compositions', number_of_tokens_tp_generate, 'tokens each')
print('=' * 70)
print('Total number of tokens to generate:', number_of_generation_cycles*number_of_batches_to_generate * number_of_tokens_tp_generate)
print('=' * 70)
...
number_of_generation_cycles = 10 # @param {type:"slider", min:1, max:256, step:1}
total_number_of_tokens_tp_generate = 3516 # @param {type:"slider", min:30, max:8190, step:3}
...
number_of_tokens_tp_generate = total_number_of_tokens_tp_generate - len(outy)
...
print('=' * 70)
print('Generating', number_of_generation_cycles * number_of_batches_to_generate, 'continuations blocks', number_of_tokens_tp_generate, 'tokens each')
print('=' * 70)
print('Total number of tokens to generate:', number_of_generation_cycles*number_of_batches_to_generate * number_of_tokens_tp_generate)
print('=' * 70)
print('Output directory:', output_dir)
...
try:
  ...
  for gc in tqdm.tqdm(range(number_of_generation_cycles)):
    ...
    with ctx:
      out = model.generate(inp,
                            total_number_of_tokens_tp_generate,
                            temperature=temperature,

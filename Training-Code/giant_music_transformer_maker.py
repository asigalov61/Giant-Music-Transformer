...
Original file is located at
    https://colab.research.google.com/github/asigalov61/Giant-Music-Transformer/blob/main/Training-Code/Giant_Music_Transformer_Maker.ipynb

# Giant Music Transformer Maker (ver. 3.0)
...
NUM_DATA_FILES_TO_LOAD_PER_ITER = 4

SEQ_LEN = 8192 # Models seq len
PAD_IDX = 22535 # Models pad index
...
for fa in range(0, len(filez), NUM_DATA_FILES_TO_LOAD_PER_ITER):
      ...
      #==========================================================================
        print('=' * 70)
        print('Loading data files', fa, '---', fa+NUM_DATA_FILES_TO_LOAD_PER_ITER)
        print('Please wait...')
        print('=' * 70)
...
x = torch.tensor([[22533, 22402+0, 22404+0]] * 4, dtype=torch.long, device=device_type)

# -*- coding: utf-8 -*-
"""Giant_Music_Transformer_Extra_Large_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/asigalov61/Giant-Music-Transformer/blob/main/Training-Code/Giant_Music_Transformer_Extra_Large_Maker.ipynb
    ...
    for t in train_d:
        ...
        if len(t) <= 8193:
            if 0 <= max(t) < PAD_IDX: # final data integrity check
                ...
                td = t + [PAD_IDX] * (8193-len(t)) # padding with pad index
...
model = TransformerWrapper(
    ...
    max_seq_len = SEQ_LEN,
    attn_layers = Decoder(dim = 1024, depth = 44, heads = 32, attn_flash = True)
    )
...
NUM_DATA_TO_LOAD_PER_ITER = 5000
...
for da in range(0, len(train_data), NUM_DATA_TO_LOAD_PER_ITER):

...
# Giant Music Transformer Training Dataset Maker (ver. 4.0)
            ...
            if min([e[1] for e in events_matrix1]) >= 0 and min([e[2] for e in events_matrix1]) >= 0:
                ...
                if len(events_matrix1) > 0 and len(instruments_list_without_drums) > 0:
                    ...
                    if 9 in instruments_list:
                        drums_present = 21763 # Yes
                    else:
                        drums_present = 21762 # No
                    ...
                    for e in events_matrix1:
                        ...
                        if delta_time != 0:
                            melody_chords.extend([bar_time, note_time+512, dur_vel+1024, pat_ptc+5120])

                        else:
                            melody_chords.extend([dur_vel+1024, pat_ptc+5120])

                        pe = e

                        melody_chords.extend([21893]) # EOS
                    ...
                    for e in events_matrix2:
                        ...
                        if delta_time != 0:
                            melody_chords_aug.extend([bar_time, note_time+512, dur_vel+1024, pat_ptc+5120])

                        else:
                            melody_chords_aug.extend([dur_vel+1024, pat_ptc+5120])

                        pe = e

                        melody_chords_aug.extend([21893]) # EOS
                    ...
                    # TOTAL DICTIONARY SIZE 21893+1=21894

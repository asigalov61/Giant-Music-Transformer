...
# Giant Music Transformer Training Dataset Maker (ver. 2.0)
            ...
            if min([e[1] for e in events_matrix1]) >= 0 and min([e[2] for e in events_matrix1]) >= 0:
              ...
              if len(events_matrix1) > 0 and len(instruments_list_without_drums) > 0:
                ...
                if 9 in instruments_list:
                  drums_present = 18819 # Yes
                else:
                  drums_present = 18818 # No
                ...
                melody_chords2.extend([18949, drums_present, 18820+pat]) # Intro seq

                #=======================================================

                # TOTAL DICTIONARY SIZE 18950+1=18951
                ...
                for m in melody_chords:
                    ...
                    if ((comp_chords_len - chords_counter) == 50) and (m[0] != 0):
                        melody_chords2.extend([18817, 18177+m[0], 18689+m[3]]) # outro seq

                    if (chords_counter % 100 == 0) and (m[0] != 0):
                        nct = 17665+min(511, ((chords_counter // 100)-1)) # chords counter token
                        melody_chords2.extend([nct, 18177+m[0], 18689+m[3]]) # chords counter seq
                        chords_counter += 1
                    else:
                        if m[0] != 0:
                            chords_counter += 1
                    ...
                    melody_chords2.extend([m[0], m[1]+512, cha_pat+1024])

                    stats[pat] += 1 # Patches stats

                melody_chords2.extend([18950, 18950, 18950]) # EOS

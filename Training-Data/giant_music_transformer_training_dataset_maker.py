...
# Giant Music Transformer Training Dataset Maker (ver. 3.0)
            ...
            if min([e[1] for e in events_matrix1]) >= 0 and min([e[2] for e in events_matrix1]) >= 0:
              ...
              if len(events_matrix1) > 0 and len(instruments_list_without_drums) > 0:
                ...
                for e in events_matrix1:
                    ...
                    e[2] = int(e[2] / 8) # Max 4 seconds for durations
                ...
                if 9 in instruments_list:
                  drums_present = 22403 # Yes
                else:
                  drums_present = 22402 # No
                ...
                melody_chords2.extend([22533, drums_present, 22404+pat]) # Intro seq

                #=======================================================

                # TOTAL DICTIONARY SIZE 22534+1=22535
                ...
                for m in melody_chords:
                    ...
                    if ((comp_chords_len - chords_counter) == 50) and (m[0] != 0):
                        melody_chords2.extend([22401, 21761+m[0], 22273+m[3]]) # outro seq

                    if (chords_counter % 100 == 0) and (m[0] != 0):
                        nct = 21249+min(511, ((chords_counter // 100)-1)) # chords counter token
                        melody_chords2.extend([nct, 21761+m[0], 22273+m[3]]) # chords counter seq
                        chords_counter += 1
                    else:
                        if m[0] != 0:
                            chords_counter += 1
                    ...
                    melody_chords2.extend([m[0], dur_vel+512, cha_pat+4608])

                    stats[pat] += 1 # Patches stats

                melody_chords2.extend([22534, 22534, 22534]) # EOS
